        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-primary-foreground/70 text-sm max-w-md mb-4">
              Helping hardware founders find execution-ready teams in their city. 
              Pre-vetted. Trusted. Ready to build.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              ...
              <li><a href="#" className="hover:text-primary-foreground transition-colors">For teams</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:hello@clustermatch.in" className="hover:text-primary-foreground transition-colors">
                  djbhavinparmar123@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <span>+91 9313323656</span>
              </li>
